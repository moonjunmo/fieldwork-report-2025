...
% 1. Region & Language
\include{chapters/1-region-and-language}

% 2. Fieldwork Preparation
\include{chapters/2-preparation}

% 3. Fieldwork Process & Results
\include{chapters/3-process}

% 4. Improvements
\include{chapters/4-improvements}

% 5. Reflection and Photos
\include{chapters/5-reflection-and-photos}

\appendix
% A. Vocabulary and Grammar
\include{chapters/a-vocabulary-and-grammar}

% B. File List
\include{chapters/b-file-list}

% C. Transcription
\ifinternal
  \include{private/c-transcription}
\else
  \include{chapters/c-transcription}
\fi
...
성공적인 언어조사를 수행할 수 있도록 가르쳐 주고 이끌어 주신 최계영 선생님께 깊은 감사의 말씀을 드립니다.
